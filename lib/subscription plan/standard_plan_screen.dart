...
class _StandardPlanState extends State<StandardPlan> {
  ...
  void _onTabChanged(int index) {
    setState(() {
      _appBarTitle = index == 0 ? 'Standard' : 'Premium'; // Update title based on selected tab
    });
  }
          ...
          children: [
            ...
            Container(
              ...
              child: TabBar(
                ...
                unselectedLabelColor: Colors.white, // Text color for the inactive tab
                indicator: BoxDecoration(
                  color: const Color(0xFF3628DD), // Background color for the active tab
                  borderRadius: BorderRadius.circular(10), // Shape for active tab
                ),
                tabs: [
                  Tab(
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: const Color(0xFF3628DD).withOpacity(0.6), // Inactive tab background
