                      ...
                      child: Text(
                        ...
                        style: const TextStyle(
                            ...
                            fontWeight: FontWeight
                                .bold), // Optional: change text color for better contrast
                      ),
                    ),
                  ),
                ),
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  IconButton(
                    icon:
                        Icon(Icons.send, color: Color.fromRGBO(54, 40, 221, 1)),
                    onPressed: _sendMessage,
                  ),
                  SizedBox(width: 5),
                  Icon(Icons.attachment_sharp, color: Colors.grey),
                  SizedBox(width: 5),
                  Icon(Icons.sentiment_satisfied_outlined, color: Colors.grey),
                ],
              ),
            ),
          ],
...
class _ProfileInfoState extends State<ProfileInfo> {
  ...
  void _onStarPressed() {
    setState(() {
      _showSuperLike = true; // Show "Super Like"
    ...
    Future.delayed(const Duration(seconds: 1), () {
      setState(() {
        _showSuperLike = false; // Hide "Super Like"
